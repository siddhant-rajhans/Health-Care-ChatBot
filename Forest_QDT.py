...
class MainForm(Frame):
    ...
    def createWidget(self):
        ...
        # var_photo_label = Label(image= var_photo, width="500" , height= "500", text= "Logo")
        # var_photo_label.pack()
        self.image = PhotoImage(file="logo_new.png")
        self.logo = Label(self, image=self.image, width="350" , height= "350")
        self.logo.pack()
        self.btnLogin=Button(self, text="Login", height="3", width="300", command = self.lblLogin_Click)
        self.btnLogin.pack()
        self.btnRegister=Button(self, text="Register", height="3", width="300", command = self.btnRegister_Click)
        self.btnRegister.pack()
        ################################## Team ################
        self.lblTeam=Label(self, text="Submitted in:", fg='#fff', bg="slateblue4", width = "250", height = "4", font=("Calibri", 13))
        self.lblTeam.pack()
